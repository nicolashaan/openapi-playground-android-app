...
import fr.haan.open_api_playground_app.data.entities.ListFollowedResponseData
...
data class UsersFollowingDeleteResponse (

    @Json(name = "data")
    val `data`: ListFollowedResponseData? = null,
