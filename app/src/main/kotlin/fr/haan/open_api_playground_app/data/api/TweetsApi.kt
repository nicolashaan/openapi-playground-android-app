...
import fr.haan.open_api_playground_app.data.entities.AddOrDeleteRulesRequest
import fr.haan.open_api_playground_app.data.entities.AddOrDeleteRulesResponse
import fr.haan.open_api_playground_app.data.entities.Error
import fr.haan.open_api_playground_app.data.entities.FilteredStreamingTweet
import fr.haan.open_api_playground_app.data.entities.GenericTweetsTimelineResponse
import fr.haan.open_api_playground_app.data.entities.Granularity
import fr.haan.open_api_playground_app.data.entities.InlineObject3
import fr.haan.open_api_playground_app.data.entities.InlineObject4
import fr.haan.open_api_playground_app.data.entities.InlineResponse200
import fr.haan.open_api_playground_app.data.entities.InlineResponse2001
import fr.haan.open_api_playground_app.data.entities.InlineResponse2002
import fr.haan.open_api_playground_app.data.entities.MultiTweetLookupResponse
import fr.haan.open_api_playground_app.data.entities.MultiUserLookupResponse
import fr.haan.open_api_playground_app.data.entities.Problem
import fr.haan.open_api_playground_app.data.entities.QuoteTweetLookupResponse
import fr.haan.open_api_playground_app.data.entities.SingleTweetLookupResponse
import fr.haan.open_api_playground_app.data.entities.StreamingTweet
import fr.haan.open_api_playground_app.data.entities.TweetCountsResponse
import fr.haan.open_api_playground_app.data.entities.TweetCreateResponse
import fr.haan.open_api_playground_app.data.entities.TweetDeleteResponse
import fr.haan.open_api_playground_app.data.entities.TweetSearchResponse
import fr.haan.open_api_playground_app.data.entities.UsersLikesCreateRequest
import fr.haan.open_api_playground_app.data.entities.UsersLikesCreateResponse
import fr.haan.open_api_playground_app.data.entities.UsersLikesDeleteResponse
import fr.haan.open_api_playground_app.data.entities.UsersRetweetsCreateRequest
import fr.haan.open_api_playground_app.data.entities.UsersRetweetsCreateResponse
import fr.haan.open_api_playground_app.data.entities.UsersRetweetsDeleteResponse
...
class TweetsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun addOrDeleteRules(addOrDeleteRulesRequest: AddOrDeleteRulesRequest, dryRun: kotlin.Boolean?) : AddOrDeleteRulesResponse {
        val localVarResponse = addOrDeleteRulesWithHttpInfo(addOrDeleteRulesRequest = addOrDeleteRulesRequest, dryRun = dryRun)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AddOrDeleteRulesResponse
    ...
    */
    ...
    fun addOrDeleteRulesWithHttpInfo(addOrDeleteRulesRequest: AddOrDeleteRulesRequest, dryRun: kotlin.Boolean?) : ApiResponse<AddOrDeleteRulesResponse?> {
        val localVariableConfig = addOrDeleteRulesRequestConfig(addOrDeleteRulesRequest = addOrDeleteRulesRequest, dryRun = dryRun)

        return request<AddOrDeleteRulesRequest, AddOrDeleteRulesResponse>(
            localVariableConfig
        )
    }
    ...
    */
    fun addOrDeleteRulesRequestConfig(addOrDeleteRulesRequest: AddOrDeleteRulesRequest, dryRun: kotlin.Boolean?) : RequestConfig<AddOrDeleteRulesRequest> {
        val localVariableBody = addOrDeleteRulesRequest
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createTweet(inlineObject3: InlineObject3?) : TweetCreateResponse {
        val localVarResponse = createTweetWithHttpInfo(inlineObject3 = inlineObject3)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TweetCreateResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createTweetWithHttpInfo(inlineObject3: InlineObject3?) : ApiResponse<TweetCreateResponse?> {
        val localVariableConfig = createTweetRequestConfig(inlineObject3 = inlineObject3)

        return request<InlineObject3, TweetCreateResponse>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun createTweetRequestConfig(inlineObject3: InlineObject3?) : RequestConfig<InlineObject3> {
    ...
    */
    ...
    fun deleteTweetById(id: kotlin.String) : TweetDeleteResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TweetDeleteResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteTweetByIdWithHttpInfo(id: kotlin.String) : ApiResponse<TweetDeleteResponse?> {
        val localVariableConfig = deleteTweetByIdRequestConfig(id = id)

        return request<Unit, TweetDeleteResponse>(
            localVariableConfig
        )
    }
    ...
    */
    ...
    fun findTweetById(id: kotlin.String, expansions: kotlin.collections.List<Expansions_findTweetById>?, tweetFields: kotlin.collections.List<TweetFields_findTweetById>?, userFields: kotlin.collections.List<UserFields_findTweetById>?, mediaFields: kotlin.collections.List<MediaFields_findTweetById>?, placeFields: kotlin.collections.List<PlaceFields_findTweetById>?, pollFields: kotlin.collections.List<PollFields_findTweetById>?) : SingleTweetLookupResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as SingleTweetLookupResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun findTweetByIdWithHttpInfo(id: kotlin.String, expansions: kotlin.collections.List<Expansions_findTweetById>?, tweetFields: kotlin.collections.List<TweetFields_findTweetById>?, userFields: kotlin.collections.List<UserFields_findTweetById>?, mediaFields: kotlin.collections.List<MediaFields_findTweetById>?, placeFields: kotlin.collections.List<PlaceFields_findTweetById>?, pollFields: kotlin.collections.List<PollFields_findTweetById>?) : ApiResponse<SingleTweetLookupResponse?> {
        ...
        return request<Unit, SingleTweetLookupResponse>(
            localVariableConfig
        )
    }
    ...
    */
     ...
     */
     enum class Exclude_findTweetsThatQuoteATweet(val value: kotlin.String) {
         @Json(name = "replies") replies("replies"),
         @Json(name = "retweets") retweets("retweets"),
         ;
     }
    ...
    */
    ...
    fun findTweetsThatQuoteATweet(id: kotlin.String, maxResults: kotlin.Int?, exclude: kotlin.collections.List<Exclude_findTweetsThatQuoteATweet>?, expansions: kotlin.collections.List<Expansions_findTweetsThatQuoteATweet>?, tweetFields: kotlin.collections.List<TweetFields_findTweetsThatQuoteATweet>?, userFields: kotlin.collections.List<UserFields_findTweetsThatQuoteATweet>?, mediaFields: kotlin.collections.List<MediaFields_findTweetsThatQuoteATweet>?, placeFields: kotlin.collections.List<PlaceFields_findTweetsThatQuoteATweet>?, pollFields: kotlin.collections.List<PollFields_findTweetsThatQuoteATweet>?) : QuoteTweetLookupResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as QuoteTweetLookupResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun findTweetsThatQuoteATweetWithHttpInfo(id: kotlin.String, maxResults: kotlin.Int?, exclude: kotlin.collections.List<Exclude_findTweetsThatQuoteATweet>?, expansions: kotlin.collections.List<Expansions_findTweetsThatQuoteATweet>?, tweetFields: kotlin.collections.List<TweetFields_findTweetsThatQuoteATweet>?, userFields: kotlin.collections.List<UserFields_findTweetsThatQuoteATweet>?, mediaFields: kotlin.collections.List<MediaFields_findTweetsThatQuoteATweet>?, placeFields: kotlin.collections.List<PlaceFields_findTweetsThatQuoteATweet>?, pollFields: kotlin.collections.List<PollFields_findTweetsThatQuoteATweet>?) : ApiResponse<QuoteTweetLookupResponse?> {
        ...
        return request<Unit, QuoteTweetLookupResponse>(
            localVariableConfig
        )
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getRules(ids: kotlin.collections.List<kotlin.String>?, maxResults: kotlin.Int?, paginationToken: kotlin.String?) : InlineResponse2001 {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRulesWithHttpInfo(ids: kotlin.collections.List<kotlin.String>?, maxResults: kotlin.Int?, paginationToken: kotlin.String?) : ApiResponse<InlineResponse2001?> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun hideReplyById(id: kotlin.String, inlineObject4: InlineObject4?) : InlineResponse200 {
        val localVarResponse = hideReplyByIdWithHttpInfo(id = id, inlineObject4 = inlineObject4)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun hideReplyByIdWithHttpInfo(id: kotlin.String, inlineObject4: InlineObject4?) : ApiResponse<InlineResponse200?> {
        val localVariableConfig = hideReplyByIdRequestConfig(id = id, inlineObject4 = inlineObject4)

        return request<InlineObject4, InlineResponse200>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun hideReplyByIdRequestConfig(id: kotlin.String, inlineObject4: InlineObject4?) : RequestConfig<InlineObject4> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun listsIdTweetsWithHttpInfo(id: kotlin.String, maxResults: kotlin.Int?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_listsIdTweets>?, tweetFields: kotlin.collections.List<TweetFields_listsIdTweets>?, userFields: kotlin.collections.List<UserFields_listsIdTweets>?, mediaFields: kotlin.collections.List<MediaFields_listsIdTweets>?, placeFields: kotlin.collections.List<PlaceFields_listsIdTweets>?, pollFields: kotlin.collections.List<PollFields_listsIdTweets>?) : ApiResponse<InlineResponse2002?> {
    ...
    */
    ...
    fun sampleStream(expansions: kotlin.collections.List<Expansions_sampleStream>?, tweetFields: kotlin.collections.List<TweetFields_sampleStream>?, userFields: kotlin.collections.List<UserFields_sampleStream>?, mediaFields: kotlin.collections.List<MediaFields_sampleStream>?, placeFields: kotlin.collections.List<PlaceFields_sampleStream>?, pollFields: kotlin.collections.List<PollFields_sampleStream>?, backfillMinutes: kotlin.Int?) : StreamingTweet {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as StreamingTweet
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun sampleStreamWithHttpInfo(expansions: kotlin.collections.List<Expansions_sampleStream>?, tweetFields: kotlin.collections.List<TweetFields_sampleStream>?, userFields: kotlin.collections.List<UserFields_sampleStream>?, mediaFields: kotlin.collections.List<MediaFields_sampleStream>?, placeFields: kotlin.collections.List<PlaceFields_sampleStream>?, pollFields: kotlin.collections.List<PollFields_sampleStream>?, backfillMinutes: kotlin.Int?) : ApiResponse<StreamingTweet?> {
        ...
        return request<Unit, StreamingTweet>(
            localVariableConfig
        )
    }
    ...
    */
    ...
    fun searchStream(expansions: kotlin.collections.List<Expansions_searchStream>?, tweetFields: kotlin.collections.List<TweetFields_searchStream>?, userFields: kotlin.collections.List<UserFields_searchStream>?, mediaFields: kotlin.collections.List<MediaFields_searchStream>?, placeFields: kotlin.collections.List<PlaceFields_searchStream>?, pollFields: kotlin.collections.List<PollFields_searchStream>?, backfillMinutes: kotlin.Int?) : FilteredStreamingTweet {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as FilteredStreamingTweet
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun searchStreamWithHttpInfo(expansions: kotlin.collections.List<Expansions_searchStream>?, tweetFields: kotlin.collections.List<TweetFields_searchStream>?, userFields: kotlin.collections.List<UserFields_searchStream>?, mediaFields: kotlin.collections.List<MediaFields_searchStream>?, placeFields: kotlin.collections.List<PlaceFields_searchStream>?, pollFields: kotlin.collections.List<PollFields_searchStream>?, backfillMinutes: kotlin.Int?) : ApiResponse<FilteredStreamingTweet?> {
        ...
        return request<Unit, FilteredStreamingTweet>(
            localVariableConfig
        )
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun tweetCountsFullArchiveSearch(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : TweetCountsResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TweetCountsResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tweetCountsFullArchiveSearchWithHttpInfo(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : ApiResponse<TweetCountsResponse?> {
        ...
        return request<Unit, TweetCountsResponse>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun tweetCountsFullArchiveSearchRequestConfig(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun tweetCountsRecentSearch(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : TweetCountsResponse {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tweetCountsRecentSearchWithHttpInfo(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : ApiResponse<TweetCountsResponse?> {
    ...
    * @return RequestConfig
    */
    fun tweetCountsRecentSearchRequestConfig(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, nextToken: kotlin.String?, paginationToken: kotlin.String?, granularity: Granularity?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("query", listOf(query.toString()))
     ...
     */
     enum class SortOrder_tweetsFullarchiveSearch(val value: kotlin.String) {
         @Json(name = "recency") recency("recency"),
         @Json(name = "relevancy") relevancy("relevancy"),
         ;
     }
    ...
    */
    ...
    fun tweetsFullarchiveSearch(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, maxResults: kotlin.Int?, sortOrder: SortOrder_tweetsFullarchiveSearch?, nextToken: kotlin.String?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_tweetsFullarchiveSearch>?, tweetFields: kotlin.collections.List<TweetFields_tweetsFullarchiveSearch>?, userFields: kotlin.collections.List<UserFields_tweetsFullarchiveSearch>?, mediaFields: kotlin.collections.List<MediaFields_tweetsFullarchiveSearch>?, placeFields: kotlin.collections.List<PlaceFields_tweetsFullarchiveSearch>?, pollFields: kotlin.collections.List<PollFields_tweetsFullarchiveSearch>?) : TweetSearchResponse {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TweetSearchResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tweetsFullarchiveSearchWithHttpInfo(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, maxResults: kotlin.Int?, sortOrder: SortOrder_tweetsFullarchiveSearch?, nextToken: kotlin.String?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_tweetsFullarchiveSearch>?, tweetFields: kotlin.collections.List<TweetFields_tweetsFullarchiveSearch>?, userFields: kotlin.collections.List<UserFields_tweetsFullarchiveSearch>?, mediaFields: kotlin.collections.List<MediaFields_tweetsFullarchiveSearch>?, placeFields: kotlin.collections.List<PlaceFields_tweetsFullarchiveSearch>?, pollFields: kotlin.collections.List<PollFields_tweetsFullarchiveSearch>?) : ApiResponse<TweetSearchResponse?> {
        val localVariableConfig = tweetsFullarchiveSearchRequestConfig(query = query, startTime = startTime, endTime = endTime, sinceId = sinceId, untilId = untilId, maxResults = maxResults, sortOrder = sortOrder, nextToken = nextToken, paginationToken = paginationToken, expansions = expansions, tweetFields = tweetFields, userFields = userFields, mediaFields = mediaFields, placeFields = placeFields, pollFields = pollFields)

        return request<Unit, TweetSearchResponse>(
            localVariableConfig
        )
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tweetsRecentSearchWithHttpInfo(query: kotlin.String, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, sinceId: kotlin.String?, untilId: kotlin.String?, maxResults: kotlin.Int?, sortOrder: SortOrder_tweetsRecentSearch?, nextToken: kotlin.String?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_tweetsRecentSearch>?, tweetFields: kotlin.collections.List<TweetFields_tweetsRecentSearch>?, userFields: kotlin.collections.List<UserFields_tweetsRecentSearch>?, mediaFields: kotlin.collections.List<MediaFields_tweetsRecentSearch>?, placeFields: kotlin.collections.List<PlaceFields_tweetsRecentSearch>?, pollFields: kotlin.collections.List<PollFields_tweetsRecentSearch>?) : ApiResponse<TweetSearchResponse?> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun usersIdLike(id: kotlin.String, usersLikesCreateRequest: UsersLikesCreateRequest?) : UsersLikesCreateResponse {
        val localVarResponse = usersIdLikeWithHttpInfo(id = id, usersLikesCreateRequest = usersLikesCreateRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as UsersLikesCreateResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdLikeWithHttpInfo(id: kotlin.String, usersLikesCreateRequest: UsersLikesCreateRequest?) : ApiResponse<UsersLikesCreateResponse?> {
        val localVariableConfig = usersIdLikeRequestConfig(id = id, usersLikesCreateRequest = usersLikesCreateRequest)

        return request<UsersLikesCreateRequest, UsersLikesCreateResponse>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun usersIdLikeRequestConfig(id: kotlin.String, usersLikesCreateRequest: UsersLikesCreateRequest?) : RequestConfig<UsersLikesCreateRequest> {
        val localVariableBody = usersLikesCreateRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json, application/problem+json"
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun usersIdLikedTweets(id: kotlin.String, maxResults: kotlin.Int?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_usersIdLikedTweets>?, tweetFields: kotlin.collections.List<TweetFields_usersIdLikedTweets>?, userFields: kotlin.collections.List<UserFields_usersIdLikedTweets>?, mediaFields: kotlin.collections.List<MediaFields_usersIdLikedTweets>?, placeFields: kotlin.collections.List<PlaceFields_usersIdLikedTweets>?, pollFields: kotlin.collections.List<PollFields_usersIdLikedTweets>?) : InlineResponse2002 {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdLikedTweetsWithHttpInfo(id: kotlin.String, maxResults: kotlin.Int?, paginationToken: kotlin.String?, expansions: kotlin.collections.List<Expansions_usersIdLikedTweets>?, tweetFields: kotlin.collections.List<TweetFields_usersIdLikedTweets>?, userFields: kotlin.collections.List<UserFields_usersIdLikedTweets>?, mediaFields: kotlin.collections.List<MediaFields_usersIdLikedTweets>?, placeFields: kotlin.collections.List<PlaceFields_usersIdLikedTweets>?, pollFields: kotlin.collections.List<PollFields_usersIdLikedTweets>?) : ApiResponse<InlineResponse2002?> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun usersIdRetweets(id: kotlin.String, usersRetweetsCreateRequest: UsersRetweetsCreateRequest?) : UsersRetweetsCreateResponse {
        val localVarResponse = usersIdRetweetsWithHttpInfo(id = id, usersRetweetsCreateRequest = usersRetweetsCreateRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as UsersRetweetsCreateResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdRetweetsWithHttpInfo(id: kotlin.String, usersRetweetsCreateRequest: UsersRetweetsCreateRequest?) : ApiResponse<UsersRetweetsCreateResponse?> {
        val localVariableConfig = usersIdRetweetsRequestConfig(id = id, usersRetweetsCreateRequest = usersRetweetsCreateRequest)

        return request<UsersRetweetsCreateRequest, UsersRetweetsCreateResponse>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun usersIdRetweetsRequestConfig(id: kotlin.String, usersRetweetsCreateRequest: UsersRetweetsCreateRequest?) : RequestConfig<UsersRetweetsCreateRequest> {
        val localVariableBody = usersRetweetsCreateRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json, application/problem+json"
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdTweetsWithHttpInfo(id: kotlin.String, sinceId: kotlin.String?, untilId: kotlin.String?, maxResults: kotlin.Int?, exclude: kotlin.collections.List<Exclude_usersIdTweets>?, paginationToken: kotlin.String?, startTime: java.time.OffsetDateTime?, endTime: java.time.OffsetDateTime?, expansions: kotlin.collections.List<Expansions_usersIdTweets>?, tweetFields: kotlin.collections.List<TweetFields_usersIdTweets>?, userFields: kotlin.collections.List<UserFields_usersIdTweets>?, mediaFields: kotlin.collections.List<MediaFields_usersIdTweets>?, placeFields: kotlin.collections.List<PlaceFields_usersIdTweets>?, pollFields: kotlin.collections.List<PollFields_usersIdTweets>?) : ApiResponse<GenericTweetsTimelineResponse?> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun usersIdUnlike(id: kotlin.String, tweetId: kotlin.String) : UsersLikesDeleteResponse {
        val localVarResponse = usersIdUnlikeWithHttpInfo(id = id, tweetId = tweetId)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as UsersLikesDeleteResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdUnlikeWithHttpInfo(id: kotlin.String, tweetId: kotlin.String) : ApiResponse<UsersLikesDeleteResponse?> {
        val localVariableConfig = usersIdUnlikeRequestConfig(id = id, tweetId = tweetId)

        return request<Unit, UsersLikesDeleteResponse>(
            localVariableConfig
        )
    }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun usersIdUnretweets(id: kotlin.String, sourceTweetId: kotlin.String) : UsersRetweetsDeleteResponse {
        val localVarResponse = usersIdUnretweetsWithHttpInfo(id = id, sourceTweetId = sourceTweetId)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as UsersRetweetsDeleteResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun usersIdUnretweetsWithHttpInfo(id: kotlin.String, sourceTweetId: kotlin.String) : ApiResponse<UsersRetweetsDeleteResponse?> {
        val localVariableConfig = usersIdUnretweetsRequestConfig(id = id, sourceTweetId = sourceTweetId)

        return request<Unit, UsersRetweetsDeleteResponse>(
            localVariableConfig
        )
    }
