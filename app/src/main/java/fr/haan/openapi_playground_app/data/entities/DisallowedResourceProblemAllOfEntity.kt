 ...
 */
@Serializable
data class DisallowedResourceProblemAllOfEntity (

    @SerialName(value = "resource_id")
    val resourceId: kotlin.String,

    @SerialName(value = "resource_type")
    val resourceType: DisallowedResourceProblemAllOfEntity.ResourceType,

    @SerialName(value = "section")
    val section: DisallowedResourceProblemAllOfEntity.Section
