...
import fr.haan.openapi_playground_app.data.entities.ListLookupMultipleUsersLookupResponseMetaEntity
 ...
 */
@Serializable
data class ListLookupMultipleUsersLookupResponseEntity (

    @SerialName(value = "data")
    val `data`: kotlin.collections.List<UserEntity>? = null,
    ...
    val meta: ListLookupMultipleUsersLookupResponseMetaEntity? = null
