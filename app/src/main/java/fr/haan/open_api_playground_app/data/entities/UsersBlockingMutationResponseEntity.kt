...
import fr.haan.open_api_playground_app.data.entities.UsersBlockingMutationResponseDataEntity
 ...
 */
@Serializable
data class UsersBlockingMutationResponseEntity (

    @SerialName(value = "data")
    val `data`: UsersBlockingMutationResponseDataEntity? = null,
