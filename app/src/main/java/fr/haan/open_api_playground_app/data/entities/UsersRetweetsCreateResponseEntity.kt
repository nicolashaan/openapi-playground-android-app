...
import fr.haan.open_api_playground_app.data.entities.UsersRetweetsCreateResponseDataEntity
 ...
 */
@Serializable
data class UsersRetweetsCreateResponseEntity (

    @SerialName(value = "data")
    val `data`: UsersRetweetsCreateResponseDataEntity? = null,
