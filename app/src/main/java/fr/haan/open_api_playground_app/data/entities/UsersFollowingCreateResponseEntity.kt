...
import fr.haan.open_api_playground_app.data.entities.UsersFollowingCreateResponseDataEntity
 ...
 */
@Serializable
data class UsersFollowingCreateResponseEntity (

    @SerialName(value = "data")
    val `data`: UsersFollowingCreateResponseDataEntity? = null,
