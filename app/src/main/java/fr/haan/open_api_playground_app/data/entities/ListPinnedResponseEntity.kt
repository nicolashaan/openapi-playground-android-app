...
import fr.haan.open_api_playground_app.data.entities.ListPinnedResponseDataEntity
 ...
 */
@Serializable
data class ListPinnedResponseEntity (

    @SerialName(value = "data")
    val `data`: ListPinnedResponseDataEntity? = null,
