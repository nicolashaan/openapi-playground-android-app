...
import fr.haan.open_api_playground_app.data.entities.ListDeleteResponseDataEntity
 ...
 */
@Serializable
data class ListDeleteResponseEntity (

    @SerialName(value = "data")
    val `data`: ListDeleteResponseDataEntity? = null,
