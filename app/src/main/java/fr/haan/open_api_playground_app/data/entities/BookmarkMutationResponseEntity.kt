...
import fr.haan.open_api_playground_app.data.entities.BookmarkMutationResponseDataEntity
 ...
 */
@Serializable
data class BookmarkMutationResponseEntity (

    @SerialName(value = "data")
    val `data`: BookmarkMutationResponseDataEntity? = null,
