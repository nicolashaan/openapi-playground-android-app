...
import fr.haan.open_api_playground_app.data.entities.UsersLikesCreateResponseDataEntity
 ...
 */
@Serializable
data class UsersLikesDeleteResponseEntity (

    @SerialName(value = "data")
    val `data`: UsersLikesCreateResponseDataEntity? = null,
