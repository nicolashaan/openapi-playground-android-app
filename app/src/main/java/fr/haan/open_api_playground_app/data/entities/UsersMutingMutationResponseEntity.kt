...
import fr.haan.open_api_playground_app.data.entities.UsersMutingMutationResponseDataEntity
 ...
 */
@Serializable
data class UsersMutingMutationResponseEntity (

    @SerialName(value = "data")
    val `data`: UsersMutingMutationResponseDataEntity? = null,
