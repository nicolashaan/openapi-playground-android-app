...
import fr.haan.open_api_playground_app.data.entities.ResourceUnauthorizedProblemAllOfEntity
 ...
 */
@Serializable
data class ResourceUnauthorizedProblemEntity (
    ...
    val section: ResourceUnauthorizedProblemEntity.Section,

    @SerialName(value = "resource_id")
    val resourceId: kotlin.String,

    @SerialName(value = "resource_type")
    val resourceType: ResourceUnauthorizedProblemEntity.ResourceType,
