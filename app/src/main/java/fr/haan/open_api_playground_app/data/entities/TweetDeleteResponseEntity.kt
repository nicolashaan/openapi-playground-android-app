...
import fr.haan.open_api_playground_app.data.entities.TweetDeleteResponseDataEntity
 ...
 */
@Serializable
data class TweetDeleteResponseEntity (

    @SerialName(value = "data")
    val `data`: TweetDeleteResponseDataEntity? = null,
