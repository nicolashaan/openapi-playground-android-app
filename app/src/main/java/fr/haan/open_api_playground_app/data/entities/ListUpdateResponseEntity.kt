...
import fr.haan.open_api_playground_app.data.entities.ListUpdateResponseDataEntity
 ...
 */
@Serializable
data class ListUpdateResponseEntity (

    @SerialName(value = "data")
    val `data`: ListUpdateResponseDataEntity? = null,
