...
import fr.haan.open_api_playground_app.data.entities.ListMemberResponseDataEntity
 ...
 */
@Serializable
data class ListMemberResponseEntity (

    @SerialName(value = "data")
    val `data`: ListMemberResponseDataEntity? = null,
