...
import fr.haan.open_api_playground_app.data.entities.TweetCreateResponseDataEntity
 ...
 */
@Serializable
data class TweetCreateResponseEntity (

    @SerialName(value = "data")
    val `data`: TweetCreateResponseDataEntity? = null,
